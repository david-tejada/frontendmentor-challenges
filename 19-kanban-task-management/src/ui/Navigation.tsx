...
export default function Navigation({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "invisible fixed -top-full left-1/2 z-20 flex w-64 -translate-x-1/2 flex-col rounded-lg bg-white transition-all duration-300 sm:absolute sm:inset-0 sm:right-auto sm:top-[4.6875rem] sm:flex sm:w-60 sm:-translate-x-full sm:rounded-none sm:border-r sm:border-blue-200 sm:border-t-purple-500 dark:border-neutral-600 dark:bg-neutral-700",
